...
//   return (
//     <>
//       <h1 className='text-3xl font-bold pl-6 mt-10'>Best Selling Products</h1>
...
//               <p className='text-left'>(0 reviews)</p>
//             </div>
    ...
    <>
      ...
      <div className="grid grid-cols-5 gap-6 p-6 w-auto">
        {products.map((i) => (
          <div 
            key={i.id} 
            className='relative group bg-white shadow-2xl border hover:shadow-black rounded-3xl p-4 text-center'
          >
            <div className='pl-42'>
            ...
            {/* Add to Cart Button - sirf hover par dikhega */}
            <button 
              onClick={() => addToCart(i)} 
              className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition"
            >
              Add to Cart
            </button>
          </div>
